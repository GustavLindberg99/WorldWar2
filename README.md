...
### Liberation
A conquered country is considered liberated during any war declaration phas where that country's partnership controls all cities in the country. When a country is considered liberated, 5 infantry strength points of that country immediately become available for build (exception: Denmark, which only had 3 strength points before it was conquered, only receives 3 strength points when it's liberated, and China can buy back all the infantry units that it had when it was conquered). Countries that never had infantry units won't receive any liberated forces. The country will not receive any additional units available for build after this, even if those units would normally be scheduled. The country receives its income every month as usual as long as it doesn't get conquered again.
...
- When China is liberated, China receives all infantry strength points that it had on the map or available for build when it was conquered, rather than only 5 strength points (it will not receive any air or naval units though). China still needs to spend money to buy these units just like any other liberated country. Just like any other liberated country, China will not receive any additional units available for build after this, even if those units would normally be scheduled.
